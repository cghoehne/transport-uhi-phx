...
start <- "200004010000" # start time in YYYYMMDDhhmm (UTC)
end   <- "201901040000"   # end time in YYYYMMDDhhmm (UTC)
# times here are selected according to ASTER data min and max dates
...
saveRDS(all.meso.w.data, here("data/outputs/temp/meso-weather-data.rds")) # all houlry weather data
saveRDS(meso.s.data, here("data/outputs/temp/meso-station-data.rds")) # all station data
