...
uza.weather <- readRDS(here("data/outputs/2017-uza-weather-data.rds")) # cleaned uza weather data
#uza.roads <- readRDS(here("data/outputs/osm-dissolved.rds")) # cleaned/clipped/buffered/dissoved UZA OSM data 
stations.buffered <- readRDS(here("data/outputs/station-buffers-sp-list.rds")) # station data buffered with appended roadway area and parking area
