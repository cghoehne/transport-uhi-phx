...
rm(osm.dt, min.park.svf, max.park.svf, fclass.info)
...
# stop cluster
stopCluster(cl)
rm(park.min.p.asph, park.min.p.conc, park.max.p.asph, park.max.p.conc, 
   ...
   veh.p.local, veh.p.minor, veh.p.major, veh.p.hiway, cl)
gc()
